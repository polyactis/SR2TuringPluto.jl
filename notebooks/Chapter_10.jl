...
# ╔═╡ c9425962-8266-44ec-9349-5d0af0c5b9ad
md"# 10 Big Entropy and Generalized Linear Model"

# ╔═╡ c8c9bdac-8e40-4179-9da7-82a0b216b616
versioninfo()

# ╔═╡ e0121ae0-58b3-4182-a8fb-6960edab4196
html"""<style>
main {
    margin: 0 auto;
    max-width: 90%;
...
# ╔═╡ 7503b0ff-7d6e-4b47-8190-12834488f436
...
md"## Code 10.1 Five hypothetical （A-E） distributions tossing 10 coins into 5 buckets"
...
md" ## Code 10.5 Calculate the expected number of blue marbles for all candidate distributions
- All must be equal to 1."
...
md" ## Code 10.6 Calculate the entropy of each candidate distribution"
...
md" ## Code 10.7 Binomial(2, 0.7): the expected number of blue marbles over 2 draws is 1.4.

- Blue vs white = 1.4 vs 0.6 = 7 vs 3
- Calculate the binomial prob for each 2-draw combo:
- WW, WB, BW, BB"
...
md" ## Code 10.8: entropy of the Binomial in 10.7"

# ╔═╡ a28c50ca-2c98-4db2-aa98-a0f51b0e57ad
-sum(A.*log.(A))

# ╔═╡ 7ad2bc63-9933-4e86-b334-96307142ac42
md" ## Code 10.9 sim_p: Simulate a random distribution with the same E(N*p)=1.4, N=2,p=0.7"
...
md" ## Code 10.10 Histogram of entropy of all simulated distribution with N*p=1.4"
...
# ╔═╡ b57023ff-b698-44fd-9d9a-bd01431ff6a5
histogram(first.(H), bins=30)

# ╔═╡ 68f78d0f-2471-4fa7-96d8-f02679adda0f
md" ## Code 10.11 Fetch entropies and distributions"
...
md" ## Code 10.12 Max entropy"

# ╔═╡ 5773f70f-0d01-46c6-934d-90d39e0a792e
maximum(entropies)

# ╔═╡ fb55b28a-8930-4b00-b1ca-e8007662ca7c
md" ## Code 10.13 The random distribution with the max entropy.
- It is almost identical to Binomial(2, 0.7)."
...
manifest_format = "2.0"
project_hash = "3d837e98f88ef8aafb470e0dd6bc3d51d8a053a7"
