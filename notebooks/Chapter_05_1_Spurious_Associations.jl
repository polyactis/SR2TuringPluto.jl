...
# ╔═╡ ba819ec2-e167-4da5-80e5-a288e9b491c4
md"# Chap 5.1"

# ╔═╡ bf34887a-649b-4144-ac27-ea640c79b910
versioninfo()
...
begin
	@time m5_1t = sample(m5_1(d.A, d.D), NUTS(), 1000)
	m5_1_df = DataFrame(m5_1t)
	@time prior = sample(m5_1([0], [0]), Prior(), 1000)
...
manifest_format = "2.0"
project_hash = "d8de755d0e5ac8f315433fef1954de5b79c37afc"
...
git-tree-sha1 = "d4ab12197672f0f4a3afb850d574cfded5fd9070"
